...
var macroExpand = function(tree) {
    ...
    if (command === "m-bind" && tree._line == 133) {
        //if (tree[1].length == 0)
            //console.log (tree[1])
    }
...
if (withSourceMap) {
    ...
    var output = handleExpressions(tree).toStringWithSourceMap({
    file: outputFilename
  });
  ...
  return banner + output.code + "\n//# sourceMappingURL=" + path.relative(path.dirname(filename), sourceMapFile);
    ...
    return banner + handleExpressions(tree).toString()
}
