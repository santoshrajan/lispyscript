                ...
                return mBind((("-" === arg1[0]) ?
                    ...
                    return mBind((("-h" === flag) ?
                        ...
                        return mBind((arg1 ?
                            ...
                            return mBind((flag === "-s"),function(withSourceMap) {
                                return mBind((function() {
                                    ...
                                    return mBind((function() {
                                    try {
                                        fs.writeFileSync(outfile,(withSourceMap ?
                                            ls._compileWithSourceMap(fs.readFileSync(infile,"utf8"),infile,withSourceMap) :
                                            ls._compile(fs.readFileSync(infile,"utf8"),infile)),"utf8");
                                        return (run ?
                                            run :
                                            null);
